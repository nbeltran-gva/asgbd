...
- **Definición:** Define la estructura de la base de datos.
- **Manipulación**: Permite modificar y utilizar los datos almacenados en la base de datos.
- **Control:** Controla permisos y privilegios.
- **Gestión:** Gestiona transacciones, confirmaciones y anulaciones.
...
Las aplicaciones se conectan a la base de datos mediante **drivers o APIs**, que permiten interactuar con el SGBD desde diferentes lenguajes de programación.
